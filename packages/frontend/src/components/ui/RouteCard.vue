...
.route-card:hover { border-color: rgba(20, 184, 166, 0.3); box-shadow: var(--shadow-sm); }
.route-card--inactive { opacity: 0.5; }

.route-card__route { display: flex; align-items: center; gap: 10px; }

.route-card__iata { font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: var(--text-primary); }
.route-card__arrow { color: var(--text-muted); font-size: 16px; }

.route-card__meta { display: flex; align-items: center; gap: 8px; }
...
.route-card__status--active { background-color: rgba(34, 197, 94, 0.12); color: var(--accent-green); }
.route-card__status--inactive { background-color: rgba(255, 255, 255, 0.05); color: var(--text-muted); }
