...
// @ts-nocheck
import locale_en_46json_fa0847c7 from "#nuxt-i18n/fa0847c7";
import locale_fr_46json_92624220 from "#nuxt-i18n/92624220";
...
export const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_fa0847c7",
      load: () => Promise.resolve(locale_en_46json_fa0847c7),
      cache: true
    }
  ],
  fr: [
    {
      key: "locale_fr_46json_92624220",
      load: () => Promise.resolve(locale_fr_46json_92624220),
      cache: true
    }
  ]
}
...
async function loadCfg(config) {
  ...
  import.meta.hot.accept("../src/assets/locales/en.json", async mod => {
    localeLoaders["en"][0].load = () => Promise.resolve(mod.default)
    await useNuxtApp()._nuxtI18nDev.resetI18nProperties("en")
  })

  import.meta.hot.accept("../src/assets/locales/fr.json", async mod => {
